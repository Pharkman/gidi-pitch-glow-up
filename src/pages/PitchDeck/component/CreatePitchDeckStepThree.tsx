...
export default function CreatePitchDeckStepThree({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4 max-sm:px-0  max-sm:z-0">
      <div className="bg-white w-full max-w-3xl rounded-3xl p-6  max-sm:p-4 shadow-2xl border max-sm:rounded-none border-gray-100 max-h-[90vh] max-sm:max-h-[100vh] flex flex-col">
        {/* Header */}
                  ...
                  <Field
                    ...
                    className={`w-full border ${
                      errors.scope && touched.scope
                        ? "border-red-400"
                        : "border-gray-200"
                    } rounded-2xl px-4 py-3 text-sm placeholder-gray-400 focus:ring-2 focus:ring-primary focus:outline-none shadow-sm transition`}
                  />
                  <ErrorMessage
                    name="scope"
                    component="div"
                              ...
                              <Field
                                ...
                                className={`w-full border ${
                                  ...
                                  touched.team?.[index]?.name
                                    ? "border-red-400"
                                    : "border-gray-200"
                                } rounded-xl px-3 py-2 text-sm placeholder-gray-400 focus:ring-2 focus:ring-primary focus:outline-none shadow-sm transition`}
                              />
                              <ErrorMessage
                                name={`team[${index}].name`}
                                component="div"
