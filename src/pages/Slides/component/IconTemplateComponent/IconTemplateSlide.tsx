export default function IconTemplateSlide({
  slide,
  brandKit,
  startupName,
}: {
  ...
  return (
    <div
      className="w-full  px-5 py-10 flex flex-col border border-gray-400"
  ...
  {slide.images?.slice(0, 3).map((img: any, index: number) => (
    ...
    >
      ...
      {/* Bullet title */}
      <h2
        className="text-[17px] mb-3 font-bold uppercase text-[#5063FF]"
        style={{ color: slideNoteColor }}
      >
      ...
      <p
        className="font-medium text-[#5063FF] text-[16px]"
