  ...
  return (
    <section className="w-full py-16 md:py-24 bg-gradient-to-r from-[#FF7442] to-[#FF5619] text-white text-center">
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 leading-tight max-sm:text-start">
          Ready to Build Your Startup?
        </h2>

        <p className="text-base sm:text-lg md:text-xl text-white/90 mb-10 leading-relaxed font-semibold max-sm:text-start">
